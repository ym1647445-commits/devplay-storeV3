    ...
    <header class="main-header">
      <div class="container nav-wrap">
        ...
        <nav id="mobileMenu" class="nav-links">
          ...
          <a class="${active === "games" ? "active" : ""}" href="games.html">
            شحن الألعاب
          </a>

          <a class="${active === "offers" ? "active" : ""}" href="offers.html">
            العروض
          </a>

          <a class="${active === "track" ? "active" : ""}" href="track.html">
            تتبع الطلب
          </a>

          <a class="${active === "account" ? "active" : ""}" href="account.html">
            حسابي
          </a>
    ...
    <footer class="footer">
      <div class="container footer-grid">
        ...
        <div>
          ...
          <p>
            <a target="_blank" href="${WHATSAPP_CHANNEL}">
              قناة واتساب
            </a>
          </p>
